...
struct Node {
    ...
    Node(AssMat newAssMat, MintermVector newFeatureVector, int newLevel, vector<CubeDecomposition> newAssignedCubeDecompositions, CubeDecomposition lastAssignedCubeDecomposition, int literalCount, vector<int> already_assigned_feature_vec, int node_index);
